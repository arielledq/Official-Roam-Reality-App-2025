    ...
    challengeDetailView = () => {
      return (
        <View style={styles.challengeInfoContainer}>
          ...
          <View
            style={{ width: "100%", paddingHorizontal: 24, marginBottom: 20 }}
          >
            <TouchableOpacity
              activeOpacity={0.6}
        ...
        <View style={styles.mainContainer}>
          ...
          >
            <View style={styles.viewDetailsIconContainer}>
              <View style={styles.viewDetailsIconContainerWrapper}>
                ...
                <TouchableOpacity
                  onPress={() =>
                    this.setState({ challengeInformationView: true })
                  }
          ...
          <View style={styles.holdTextContainer}>
            {!this.state.capturedImage &&
              ...
              challengeObj?.ar_filters.length == 0 && (
                <Text style={styles.holdText}>
                  Press and hold the capture button to start recording. Release
                  to stop
                </Text>
              )}
            {(this.state.capturedImage || this.state.capturedVideo) &&
              route?.params?.challengeObj?.ar_filters.length > 0 && (
                <Text style={styles.holdText}>
                  Swipe Left or Right for Filters
                </Text>
              )}
          </View>
          <View
