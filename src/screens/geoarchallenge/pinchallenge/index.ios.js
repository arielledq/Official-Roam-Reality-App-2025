...
const PinChallenge = ({}) => {
        ...
        {challengeObj?.challenge_choice == "3DMODEL" &&
          ...
          isMeInsideInSite && (
            <Viro3DObject
              ...
              onDrag={
                challengeObjParameters?.tracking_and_anchors ? _onDrag : null
              }
              animation={{
                name: "Take 001",
                run: true,
  ...
  class ViroARNavigator extends React.Component {
    ...
    findNearPoint = position => {
      ...
      const neareastPoint = findNearestLocationPoint(
        position.coords,
        arrayPoints
      )
    ...
    isCurrentLocationIsInArea = position => {
      ...
      for (i = 0; i < selectedGeoSite.geo_site_border.coordinates.length; i++) {
        ...
        console.log(
          "isCurrentLocationIsInArea position.coords:",
          position.coords
        )
    ...
    async _takeScreenshot() {
      if (this.state.isMeInsideInSite) {
        ...
        this._arNavigator._takeScreenshot(uuid.v4(), false).then(retDict => {
          ...
          this.setState({
            capturedImage:
              Platform.OS === "android" ? `file://${retDict.url}` : retDict.url
          })
        })
      } else {
        ...
        <View style={{ flex: 1 }}>
          <BackgroundWithImage style={_styles.mainContainer}>
                ...
                <View style={{ flexDirection: "row" }}>
                  ...
                  <View>
                    ...
                    <Text style={_styles.arrivedText}>
                      {this.state.isMeInsideInSite ? 1 : 0} / 1
                    </Text>
                  </View>
                </View>
                <View style={{ flexDirection: "row" }}>
            ...
            >
              ...
              >
                <View
                  style={{ flex: 1, marginTop: -240, position: "relative" }}
                >
                  ...
                  <TouchableOpacity
                    disabled={this.state.capturedImage ? true : false}
                    onPress={() => {
                  ...
                  {this.state.capturedImage && (
                    ...
                    >
                      <TouchableOpacity
                        onPress={() => this.setState({ capturedImage: null })}
                        activeOpacity={0.8}
              ...
              >
                ...
                >
                  ...
                  >
                    <RadarBlipIcon
                      style={{ width: 10, height: 10, marginEnd: 25 }}
                    />
                    <TouchableOpacity>
                ...
                <View style={{ flexDirection: "row" }}>
                  ...
                  <Text style={_styles.infoText}>
                    The closer you get to the Pin faster the chime beeps and
                    quicker the dot pulsates. You can switch off the Sound by
