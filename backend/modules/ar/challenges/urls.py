...
router.register(r'geo-ar-location-mini', GeoLocationMiniViewSet, basename='geolocation-mini')
router.register(r'geo-ar-site', GeoArSiteViewSet)
router.register(r'geo-ar-star', GeoArStarViewSet, basename="ar-stars")
router.register(r'geo-ar-star-collect', StarCollectionViewSet, basename="ar-star-collect")
